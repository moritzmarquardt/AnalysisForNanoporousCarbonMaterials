...
from AnalysisForNanoporousCarbonMaterials.core_functions import (
    findPassages,
    fit_diffusion_pdf,
    fitfunc_hom,
    save_1darr_to_txt,
...
class DiffusionAnalysis(MembraneAnalysis):
    ...
    def calc_diffusion(self, selector: str, D_guess: float):
        """
        Calculates the diffusion coefficient for the given selector using a PDF fit.
    ...
    def plot_diffusion(self, selector: str):
        ...
        Returns:
            fig (matplotlib.figure.Figure): The figure with the diffusion fit.
        ...
        # PLOT DATA
        x_lim = centertime * 4
        x_pdf = np.linspace(0, x_lim * 2, 200)
        fs = "x-large"
        figsize = (8, 3)
